    ...
    return (
        <Box className="Service" sx={sx}>
            <Box className="Service-Title">
                <Typography className="Service-Title-Title" variant="h1"><a className="aqua">S</a>ERVICE</Typography>
                <Typography className="Service-Title-Text" variant="h6">事業内容</Typography>
            </Box>

            <Box className="Programmers-Guild">
                <Box className="Image1"><img className="Mainvisual-Image" src={ServiceImg1} alt="profile" /></Box>
                <Box className="Text1">
                    <Typography>プログラマーズギルド</Typography>
                    <Typography className="Text-guild" variant="h4">Programmers Guild</Typography>
                    <Typography className="Text-kaihatu" variant="h6">チーム開発の請負サービス</Typography>
            ...
            <Box className="Techno-Element">
                ...
                <Box className="Text2">
                    <Typography>テクノエレメント</Typography>
                    <Typography className="Text-guild" variant="h4">Techno Element</Typography>
                    <Typography className="Text-kaihatu" variant="h6">フレキシブルなSES事業</Typography>
                    <Typography className="Text-text">
            ...
            <Box className="Top-engineer-Experience-Program">
                ...
                <Box className="Text3">
                    <Typography>エンジニア教育</Typography>
                    <Typography className="Text-guild" variant="h4">Top engineer Experience Program</Typography>
                    <Typography className="Text-kaihatu" variant="h6">トップエンジニアとの開発を体験する</Typography>
                    <Typography className="Text-text">
