    ...
    return (
        <Box className="About" sx={sx}>
            <Box className="About-Title">
                <Typography className="About-Title-Title" variant="h1"><a className="About-Text-Lightblue">A</a>BOUT</Typography>
                <Typography className="About-Title-Sub" variant="h6">私たちについて</Typography>
            </Box>
